...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-08-2025 a las 15:08:57
...
INSERT INTO `marcas` (`cod_marca`, `descripcion`, `estado`) VALUES
(1, 'Marca 1', 'ACTIVO');
...
(5, '2025-08-03', 'PENDIENTE', 1, 1, 1),
(6, '2025-08-03', 'PENDIENTE', 1, 1, 1);
...
(1, '2024-12-17', '2024-12-17', 'UTILIZADO', 2, 1, 1, 1),
...
INSERT INTO `producto` (`cod_producto`, `nombre`, `descripcion`, `precio`, `cod_marca`, `estado`) VALUES
(1, 'PRODUCTO', 'ASDA', 200000, 1, 'ACTIVO');
...
(1, 'anibal', '202cb962ac59075b964b07152d234b70', 'ACTIVO', 1, 1, 1, 123, 0, 3);
...
ALTER TABLE `det_orden`
  ...
  ADD KEY `insumos_det_orden_fk` (`cod_producto`);
...
--
ALTER TABLE `det_orden`
  ADD CONSTRAINT `insumos_det_orden_fk` FOREIGN KEY (`cod_producto`) REFERENCES `insumos` (`cod_insumos`) ON DELETE NO ACTION ON UPDATE NO ACTION,
